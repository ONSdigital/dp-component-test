...
| I should receive the following JSON response with "INT" dynamic timestamp(s): \_BODY\_ | Assert that the response body is JSON, matches BODY and contains INT dynamic timestamps | Then              |
